...
const Navbar = () => {
    ...
    const { setShowSearch, getCartCount, navigate, token, setToken, cartIems, setCartItems} = useContext(ShopContext);
  ...
  return (
      ...
      <div className='flex items-center justify-between py-5 font-medium'>
        <Link to='/'><img src={logo} className='w-36' alt="Forever" /></Link>
        ...
        <div className='flex items-center gap-6'>
            <img onClick={()=>setShowSearch(true)} className='w-5 cursor-pointer'  src={search_icon} alt="" />
